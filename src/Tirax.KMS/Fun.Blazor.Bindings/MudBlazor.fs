...
type MudTableBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    /// Set the position of the CommitEdit and CancelEdit button, if IsEditable IsEditable is true. Defaults to the end of the row
    ...
    /// Set the position of the StartEdit button, if IsEditable IsEditable is true. Defaults to the end of the row
...
module DslCE =
    ...
    type MudComponentBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudComponentBase>)>] () = inherit MudComponentBaseBuilder<MudComponentBase>()
    type MudBaseButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseButton>)>] () = inherit MudBaseButtonBuilder<MudBaseButton>()
    type MudButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudButton>)>] () = inherit MudButtonBuilder<MudButton>()
    type MudFab' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudFab>)>] () = inherit MudFabBuilder<MudFab>()
    type MudIconButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudIconButton>)>] () = inherit MudIconButtonBuilder<MudIconButton>()
    type MudDrawerContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDrawerContainer>)>] () = inherit MudDrawerContainerBuilder<MudDrawerContainer>()
    type MudLayout' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudLayout>)>] () = inherit MudLayoutBuilder<MudLayout>()
    type MudBaseSelectItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseSelectItem>)>] () = inherit MudBaseSelectItemBuilder<MudBaseSelectItem>()
    type MudNavLink' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudNavLink>)>] () = inherit MudNavLinkBuilder<MudNavLink>()

    /// Represents an option of a select or multi-select. To be used inside MudSelect.
    type MudSelectItem'<'T> 
        /// Represents an option of a select or multi-select. To be used inside MudSelect.
        [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSelectItem<_>>)>] () = inherit MudSelectItemBuilder<MudSelectItem<'T>, 'T>()
    type MudTableBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTableBase>)>] () = inherit MudTableBaseBuilder<MudTableBase>()
    type MudTable'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTable<_>>)>] () = inherit MudTableBuilder<MudTable<'T>, 'T>()
    type MudTabs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTabs>)>] () = inherit MudTabsBuilder<MudTabs>()
    type MudDynamicTabs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDynamicTabs>)>] () = inherit MudDynamicTabsBuilder<MudDynamicTabs>()
    type MudChartBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudChartBase>)>] () = inherit MudChartBaseBuilder<MudChartBase>()
    type MudChart' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudChart>)>] () = inherit MudChartBuilder<MudChart>()
    type MudBaseItemsControl'<'TChildComponent when 'TChildComponent :> MudComponentBase> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseItemsControl<_>>)>] () = inherit MudBaseItemsControlBuilder<MudBaseItemsControl<'TChildComponent>, 'TChildComponent>()
    type MudBaseBindableItemsControl'<'TChildComponent, 'TData when 'TChildComponent :> MudComponentBase> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseBindableItemsControl<_, _>>)>] () = inherit MudBaseBindableItemsControlBuilder<MudBaseBindableItemsControl<'TChildComponent, 'TData>, 'TChildComponent, 'TData>()
    type MudCarousel'<'TData> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCarousel<_>>)>] () = inherit MudCarouselBuilder<MudCarousel<'TData>, 'TData>()
    type MudTimeline' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTimeline>)>] () = inherit MudTimelineBuilder<MudTimeline>()
    type MudFormComponent'<'T, 'U> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudFormComponent<_, _>>)>] () = inherit MudFormComponentBuilder<MudFormComponent<'T, 'U>, 'T, 'U>()
    type MudBaseInput'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseInput<_>>)>] () = inherit MudBaseInputBuilder<MudBaseInput<'T>, 'T>()
    type MudAutocomplete'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAutocomplete<_>>)>] () = inherit MudAutocompleteBuilder<MudAutocomplete<'T>, 'T>()
    type MudDebouncedInput'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDebouncedInput<_>>)>] () = inherit MudDebouncedInputBuilder<MudDebouncedInput<'T>, 'T>()
    type MudNumericField'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudNumericField<_>>)>] () = inherit MudNumericFieldBuilder<MudNumericField<'T>, 'T>()
    type MudTextField'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTextField<_>>)>] () = inherit MudTextFieldBuilder<MudTextField<'T>, 'T>()
    type MudInput'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudInput<_>>)>] () = inherit MudInputBuilder<MudInput<'T>, 'T>()
    type MudInputString' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudInputString>)>] () = inherit MudInputStringBuilder<MudInputString>()
    type MudRangeInput'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRangeInput<_>>)>] () = inherit MudRangeInputBuilder<MudRangeInput<'T>, 'T>()
    type MudMask' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudMask>)>] () = inherit MudMaskBuilder<MudMask>()
    type MudSelect'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSelect<_>>)>] () = inherit MudSelectBuilder<MudSelect<'T>, 'T>()
    type MudBooleanInput'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBooleanInput<_>>)>] () = inherit MudBooleanInputBuilder<MudBooleanInput<'T>, 'T>()
    type MudCheckBox'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCheckBox<_>>)>] () = inherit MudCheckBoxBuilder<MudCheckBox<'T>, 'T>()
    type MudSwitch'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSwitch<_>>)>] () = inherit MudSwitchBuilder<MudSwitch<'T>, 'T>()
    type MudFileUpload'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudFileUpload<_>>)>] () = inherit MudFileUploadBuilder<MudFileUpload<'T>, 'T>()
    type MudPicker'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPicker<_>>)>] () = inherit MudPickerBuilder<MudPicker<'T>, 'T>()
    type MudBaseDatePicker' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseDatePicker>)>] () = inherit MudBaseDatePickerBuilder<MudBaseDatePicker>()
    type MudDatePicker' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDatePicker>)>] () = inherit MudDatePickerBuilder<MudDatePicker>()
    type MudDateRangePicker' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDateRangePicker>)>] () = inherit MudDateRangePickerBuilder<MudDateRangePicker>()
    type MudColorPicker' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudColorPicker>)>] () = inherit MudColorPickerBuilder<MudColorPicker>()
    type MudTimePicker' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTimePicker>)>] () = inherit MudTimePickerBuilder<MudTimePicker>()
    type MudRadioGroup'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRadioGroup<_>>)>] () = inherit MudRadioGroupBuilder<MudRadioGroup<'T>, 'T>()
    type MudAlert' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAlert>)>] () = inherit MudAlertBuilder<MudAlert>()
    type MudAppBar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAppBar>)>] () = inherit MudAppBarBuilder<MudAppBar>()
    type MudAvatar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAvatar>)>] () = inherit MudAvatarBuilder<MudAvatar>()
    type MudAvatarGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAvatarGroup>)>] () = inherit MudAvatarGroupBuilder<MudAvatarGroup>()
    type MudBadge' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBadge>)>] () = inherit MudBadgeBuilder<MudBadge>()
    type MudBreadcrumbs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBreadcrumbs>)>] () = inherit MudBreadcrumbsBuilder<MudBreadcrumbs>()
    type MudBreakpointProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBreakpointProvider>)>] () = inherit MudBreakpointProviderBuilder<MudBreakpointProvider>()
    type MudToggleIconButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudToggleIconButton>)>] () = inherit MudToggleIconButtonBuilder<MudToggleIconButton>()
    type MudButtonGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudButtonGroup>)>] () = inherit MudButtonGroupBuilder<MudButtonGroup>()
    type MudCard' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCard>)>] () = inherit MudCardBuilder<MudCard>()
    type MudCardActions' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCardActions>)>] () = inherit MudCardActionsBuilder<MudCardActions>()
    type MudCardContent' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCardContent>)>] () = inherit MudCardContentBuilder<MudCardContent>()
    type MudCardHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCardHeader>)>] () = inherit MudCardHeaderBuilder<MudCardHeader>()
    type MudCardMedia' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCardMedia>)>] () = inherit MudCardMediaBuilder<MudCardMedia>()
    type MudCarouselItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCarouselItem>)>] () = inherit MudCarouselItemBuilder<MudCarouselItem>()
    type MudChip' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudChip>)>] () = inherit MudChipBuilder<MudChip>()
    type MudChipSet' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudChipSet>)>] () = inherit MudChipSetBuilder<MudChipSet>()
    type MudCollapse' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudCollapse>)>] () = inherit MudCollapseBuilder<MudCollapse>()
    type Column'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Column<_>>)>] () = inherit ColumnBuilder<Column<'T>, 'T>()
    type PropertyColumn'<'T, 'TProperty> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<PropertyColumn<_, _>>)>] () = inherit PropertyColumnBuilder<PropertyColumn<'T, 'TProperty>, 'T, 'TProperty>()
    type TemplateColumn'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<TemplateColumn<_>>)>] () = inherit TemplateColumnBuilder<TemplateColumn<'T>, 'T>()
    type FilterHeaderCell'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<FilterHeaderCell<_>>)>] () = inherit FilterHeaderCellBuilder<FilterHeaderCell<'T>, 'T>()
    type FooterCell'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<FooterCell<_>>)>] () = inherit FooterCellBuilder<FooterCell<'T>, 'T>()
    type HeaderCell'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<HeaderCell<_>>)>] () = inherit HeaderCellBuilder<HeaderCell<'T>, 'T>()
    type MudDataGrid'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDataGrid<_>>)>] () = inherit MudDataGridBuilder<MudDataGrid<'T>, 'T>()
    type MudDataGridPager'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDataGridPager<_>>)>] () = inherit MudDataGridPagerBuilder<MudDataGridPager<'T>, 'T>()
    type Row' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Row>)>] () = inherit RowBuilder<Row>()
    type MudDialog' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDialog>)>] () = inherit MudDialogBuilder<MudDialog>()
    type MudDialogInstance' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDialogInstance>)>] () = inherit MudDialogInstanceBuilder<MudDialogInstance>()
    type MudDrawer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDrawer>)>] () = inherit MudDrawerBuilder<MudDrawer>()

    /// The container of a drag and drop zones
    type MudDropContainer'<'T> 
        /// The container of a drag and drop zones
        [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDropContainer<_>>)>] () = inherit MudDropContainerBuilder<MudDropContainer<'T>, 'T>()
    type MudDropZone'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDropZone<_>>)>] () = inherit MudDropZoneBuilder<MudDropZone<'T>, 'T>()
    type MudDynamicDropItem'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDynamicDropItem<_>>)>] () = inherit MudDynamicDropItemBuilder<MudDynamicDropItem<'T>, 'T>()
    ...
    type MudElement' 
        /// Primitive component which allows rendering any HTML element we want
        /// through the HtmlTag property
        [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudElement>)>] () = inherit MudElementBuilder<MudElement>()
    type MudExpansionPanel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudExpansionPanel>)>] () = inherit MudExpansionPanelBuilder<MudExpansionPanel>()
    type MudExpansionPanels' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudExpansionPanels>)>] () = inherit MudExpansionPanelsBuilder<MudExpansionPanels>()
    type MudField' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudField>)>] () = inherit MudFieldBuilder<MudField>()
    type MudFocusTrap' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudFocusTrap>)>] () = inherit MudFocusTrapBuilder<MudFocusTrap>()
    type MudForm' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudForm>)>] () = inherit MudFormBuilder<MudForm>()
    type MudHidden' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudHidden>)>] () = inherit MudHiddenBuilder<MudHidden>()
    type MudHighlighter' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudHighlighter>)>] () = inherit MudHighlighterBuilder<MudHighlighter>()
    type MudIcon' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudIcon>)>] () = inherit MudIconBuilder<MudIcon>()
    type MudImage' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudImage>)>] () = inherit MudImageBuilder<MudImage>()
    type MudInputLabel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudInputLabel>)>] () = inherit MudInputLabelBuilder<MudInputLabel>()
    type MudInputControl' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudInputControl>)>] () = inherit MudInputControlBuilder<MudInputControl>()
    type MudLink' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudLink>)>] () = inherit MudLinkBuilder<MudLink>()
    type MudList' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudList>)>] () = inherit MudListBuilder<MudList>()
    type MudListItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudListItem>)>] () = inherit MudListItemBuilder<MudListItem>()
    type MudListSubheader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudListSubheader>)>] () = inherit MudListSubheaderBuilder<MudListSubheader>()
    type MudMenu' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudMenu>)>] () = inherit MudMenuBuilder<MudMenu>()
    type MudMenuItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudMenuItem>)>] () = inherit MudMenuItemBuilder<MudMenuItem>()
    type MudMessageBox' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudMessageBox>)>] () = inherit MudMessageBoxBuilder<MudMessageBox>()
    type MudNavGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudNavGroup>)>] () = inherit MudNavGroupBuilder<MudNavGroup>()
    type MudNavMenu' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudNavMenu>)>] () = inherit MudNavMenuBuilder<MudNavMenu>()
    type MudOverlay' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudOverlay>)>] () = inherit MudOverlayBuilder<MudOverlay>()
    type MudPageContentNavigation' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPageContentNavigation>)>] () = inherit MudPageContentNavigationBuilder<MudPageContentNavigation>()
    type MudPagination' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPagination>)>] () = inherit MudPaginationBuilder<MudPagination>()
    type MudPaper' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPaper>)>] () = inherit MudPaperBuilder<MudPaper>()
    type MudPopover' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPopover>)>] () = inherit MudPopoverBuilder<MudPopover>()
    type MudProgressCircular' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudProgressCircular>)>] () = inherit MudProgressCircularBuilder<MudProgressCircular>()
    type MudProgressLinear' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudProgressLinear>)>] () = inherit MudProgressLinearBuilder<MudProgressLinear>()
    type MudRadio'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRadio<_>>)>] () = inherit MudRadioBuilder<MudRadio<'T>, 'T>()
    type MudRating' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRating>)>] () = inherit MudRatingBuilder<MudRating>()
    type MudRatingItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRatingItem>)>] () = inherit MudRatingItemBuilder<MudRatingItem>()
    type MudRTLProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRTLProvider>)>] () = inherit MudRTLProviderBuilder<MudRTLProvider>()
    type MudScrollToTop' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudScrollToTop>)>] () = inherit MudScrollToTopBuilder<MudScrollToTop>()
    type MudSkeleton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSkeleton>)>] () = inherit MudSkeletonBuilder<MudSkeleton>()
    type MudSlider'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSlider<_>>)>] () = inherit MudSliderBuilder<MudSlider<'T>, 'T>()
    type MudSnackbarElement' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSnackbarElement>)>] () = inherit MudSnackbarElementBuilder<MudSnackbarElement>()
    type MudSnackbarProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSnackbarProvider>)>] () = inherit MudSnackbarProviderBuilder<MudSnackbarProvider>()
    type MudStack' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudStack>)>] () = inherit MudStackBuilder<MudStack>()
    type MudSwipeArea' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSwipeArea>)>] () = inherit MudSwipeAreaBuilder<MudSwipeArea>()
    type MudTableGroupRow'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTableGroupRow<_>>)>] () = inherit MudTableGroupRowBuilder<MudTableGroupRow<'T>, 'T>()
    type MudTablePager' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTablePager>)>] () = inherit MudTablePagerBuilder<MudTablePager>()
    type MudTableSortLabel'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTableSortLabel<_>>)>] () = inherit MudTableSortLabelBuilder<MudTableSortLabel<'T>, 'T>()
    type MudTd' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTd>)>] () = inherit MudTdBuilder<MudTd>()
    type MudTFootRow' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTFootRow>)>] () = inherit MudTFootRowBuilder<MudTFootRow>()
    type MudTh' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTh>)>] () = inherit MudThBuilder<MudTh>()
    type MudTHeadRow' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTHeadRow>)>] () = inherit MudTHeadRowBuilder<MudTHeadRow>()
    type MudTr' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTr>)>] () = inherit MudTrBuilder<MudTr>()
    type MudSimpleTable' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSimpleTable>)>] () = inherit MudSimpleTableBuilder<MudSimpleTable>()
    type MudTimelineItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTimelineItem>)>] () = inherit MudTimelineItemBuilder<MudTimelineItem>()
    type MudTooltip' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTooltip>)>] () = inherit MudTooltipBuilder<MudTooltip>()
    type MudTreeView'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTreeView<_>>)>] () = inherit MudTreeViewBuilder<MudTreeView<'T>, 'T>()
    type MudTreeViewItem'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTreeViewItem<_>>)>] () = inherit MudTreeViewItemBuilder<MudTreeViewItem<'T>, 'T>()
    type MudText' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudText>)>] () = inherit MudTextBuilder<MudText>()
    type MudContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudContainer>)>] () = inherit MudContainerBuilder<MudContainer>()
    type HierarchyColumn'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<HierarchyColumn<_>>)>] () = inherit HierarchyColumnBuilder<HierarchyColumn<'T>, 'T>()
    type MudDivider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDivider>)>] () = inherit MudDividerBuilder<MudDivider>()
    type MudDrawerHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDrawerHeader>)>] () = inherit MudDrawerHeaderBuilder<MudDrawerHeader>()
    type MudGrid' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudGrid>)>] () = inherit MudGridBuilder<MudGrid>()
    type MudItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudItem>)>] () = inherit MudItemBuilder<MudItem>()
    type MudMainContent' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudMainContent>)>] () = inherit MudMainContentBuilder<MudMainContent>()
    type MudSparkLine' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSparkLine>)>] () = inherit MudSparkLineBuilder<MudSparkLine>()
    type MudTabPanel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTabPanel>)>] () = inherit MudTabPanelBuilder<MudTabPanel>()
    type MudToolBar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudToolBar>)>] () = inherit MudToolBarBuilder<MudToolBar>()
    type MudBaseColumn' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudBaseColumn>)>] () = inherit MudBaseColumnBuilder<MudBaseColumn>()

    /// Binds an object's property to a column by its property name 
    type MudColumn'<'T> 
        /// Binds an object's property to a column by its property name 
        [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudColumn<_>>)>] () = inherit MudColumnBuilder<MudColumn<'T>, 'T>()

    /// Binds an object's property to a column by its property name 
    type MudSortableColumn'<'T, 'ModelType> 
        /// Binds an object's property to a column by its property name 
        [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSortableColumn<_, _>>)>] () = inherit MudSortableColumnBuilder<MudSortableColumn<'T, 'ModelType>, 'T, 'ModelType>()
    type MudAvatarColumn'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudAvatarColumn<_>>)>] () = inherit MudAvatarColumnBuilder<MudAvatarColumn<'T>, 'T>()
    type MudTemplateColumn'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTemplateColumn<_>>)>] () = inherit MudTemplateColumnBuilder<MudTemplateColumn<'T>, 'T>()
    type BaseMudThemeProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<BaseMudThemeProvider>)>] () = inherit BaseMudThemeProviderBuilder<BaseMudThemeProvider>()
    type MudThemeProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudThemeProvider>)>] () = inherit MudThemeProviderBuilder<MudThemeProvider>()
    type SelectColumn'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<SelectColumn<_>>)>] () = inherit SelectColumnBuilder<SelectColumn<'T>, 'T>()
    type MudDialogProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudDialogProvider>)>] () = inherit MudDialogProviderBuilder<MudDialogProvider>()
    type MudPopoverProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPopoverProvider>)>] () = inherit MudPopoverProviderBuilder<MudPopoverProvider>()
    type MudVirtualize'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudVirtualize<_>>)>] () = inherit MudVirtualizeBuilder<MudVirtualize<'T>, 'T>()
    type BreadcrumbLink' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<BreadcrumbLink>)>] () = inherit BreadcrumbLinkBuilder<BreadcrumbLink>()
    type BreadcrumbSeparator' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<BreadcrumbSeparator>)>] () = inherit BreadcrumbSeparatorBuilder<BreadcrumbSeparator>()
    type MudPickerContent' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPickerContent>)>] () = inherit MudPickerContentBuilder<MudPickerContent>()
    type MudPickerToolbar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudPickerToolbar>)>] () = inherit MudPickerToolbarBuilder<MudPickerToolbar>()
    type MudRender' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudRender>)>] () = inherit MudRenderBuilder<MudRender>()
    type MudSpacer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudSpacer>)>] () = inherit MudSpacerBuilder<MudSpacer>()
    type MudTreeViewItemToggleButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudTreeViewItemToggleButton>)>] () = inherit MudTreeViewItemToggleButtonBuilder<MudTreeViewItemToggleButton>()
    type _Imports' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<_Imports>)>] () = inherit _ImportsBuilder<_Imports>()
...
module DslCE =
    ...
    type Bar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Bar>)>] () = inherit BarBuilder<Bar>()
    type Donut' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Donut>)>] () = inherit DonutBuilder<Donut>()
    type Line' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Line>)>] () = inherit LineBuilder<Line>()
    type Pie' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Pie>)>] () = inherit PieBuilder<Pie>()
    type Legend' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Legend>)>] () = inherit LegendBuilder<Legend>()
    type Filters' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Filters>)>] () = inherit FiltersBuilder<Filters>()
...
module DslCE =
    ...
    type MudInputAdornment' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<MudInputAdornment>)>] () = inherit MudInputAdornmentBuilder<MudInputAdornment>()
...
module DslCE =
    ...
    type SnackbarMessageRenderFragment' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<SnackbarMessageRenderFragment>)>] () = inherit SnackbarMessageRenderFragmentBuilder<SnackbarMessageRenderFragment>()
    type SnackbarMessageText' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<SnackbarMessageText>)>] () = inherit SnackbarMessageTextBuilder<SnackbarMessageText>()